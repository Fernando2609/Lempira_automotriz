        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item  ">
                <a href="<?php print RUTA."admonModelo" ?>" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                  <p>Modelo</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a href="<?php print RUTA; ?>AdmonModelo/alta" class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Modelo      </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Caratula" target="_blank" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Caratula_e" class="btn btn-block btn-outline-success" style="width: 20%;">     <i class="far fa-file-excel"></i>   Reporte Excel
              </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    for($i=0; $i<count($datos['data']); $i++){
                      ...
                      $num=$i+1;
                      print "<td >".$num."</td>";
                      print "<td >".$datos["data"][$i]["ID_MODELO"]."</td>";
                      print "<td >".$datos["data"][$i]["Descripcion2"]."</td>";
                      print "<td >".$datos["data"][$i]["DESCRIPCION"]."</td>";
                      //Botones
                      print "<td style='text-align: -webkit-center;'><a href='".RUTA."AdmonModelo/cambio/".$datos["data"][$i]["ID_MODELO"]."'
                        class='btn btn-block w-50 bg-gradient-success btn-flat'><i class='fas fa-edit'></i></a></td>";
