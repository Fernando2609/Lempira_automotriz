...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php print RUTA.'AdmonInicio/caratula'  ?>" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              <li class="nav-item  ">
                <a href="<?php print RUTA."admonUsuarios" ?>" class="nav-link active ">
      ...
      <div class="container-fluid">
        ...
        if (isset($datos["errores"])) {
          if (count($datos["errores"])>0) {
            print "<div class='alert alert-danger text-center mb-5  justify-content-center centrar'>";
      ...
      ?>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Modificar Administrador</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a class="btn btn-block btn-warning btn-flat w-25" href="<?php print RUTA. "admonUsuarios/cambioClavePerfil/".$_SESSION["email"]["email"] ?>" class="btn btn-warning mr-3">Cambiar Contraseña</a>
              </div>
              <form action="<?php print RUTA; ?>admonUsuarios/cambio2/" method="POST">
              <div class="form-group text-left">
                  <label for="correo">* Correo:</label>
                  <input type="email" name="correo" class="form-control form-control-border border-width-2" required
                ...
                <div class="form-group text-left">
                  ...
                  <input type="text" name="nombre" class="form-control form-control-border border-width-2"
                ...
                <div class="form-group text-left">
                  ...
                  <input type="text" name="telefono_celular" class="form-control form-control-border border-width-2"
                ...
                <div class="form-group text-left">
                  ...
                  <input type="text" name="telefono_fijo" class="form-control form-control-border border-width-2"
                ...
                <div class="form-group text-left">
                  ...
                  <input type="text" name="direccion" class="form-control form-control-border border-width-2"
                ...
                <div class="form-group text-left">
                  ...
                  <input type="text" name="no_identidad" class="form-control form-control-border border-width-2"
                ...
                <div class="form-group text-left">
                  ...
                  <input type="date" name="fecha_nacimiento" class="form-control form-control-border border-width-2"
