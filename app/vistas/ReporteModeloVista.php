...
function Header()
{
    ...
    $this->Cell(120,10,'REPORTE DE MODELOS',1,0,'C',1);
    ...
    $this->Cell(10,10,'',0,0,'C',0);
    $this->Cell(10,10,utf8_decode('No'),1,0,'C',1);
    $this->Cell(40,10,utf8_decode('ID MODELO'),1,0,'C',1);
    $this->Cell(60,10,utf8_decode('MODELO'),1,0,'C',1);
...
function Footer()
{
  ...
  for($i=0; $i<count($datos['data']); $i++){
    ...
    $pdf->Cell(40,10,utf8_decode($datos["data"][$i]["ID_MODELO"]) ,1,0,'C',0);
    $pdf->Cell(60,10,utf8_decode($datos["data"][$i]["Descripcion2"]),1,0,'C',0);
