...
<html lang="en">
  <head>
    ...
    <link href="<?php print RUTA.'assets/css/hover.css'; ?>" rel="stylesheet" />
    ...
    <main id="main">
      ...
      <section class="breadcrumbs">
        <div class="container">
          ...
          <?php  
              print "<h2> Marca ".$datos["marca"]["DESCRIPCION"]."</h2>"
            ...
            <?php  
            print "<li>".$datos["marca"]["DESCRIPCION"]."</li>";
      ...
      <div class="container container2" data-aos="fade-down">
      <?php
   $ren = 0;
