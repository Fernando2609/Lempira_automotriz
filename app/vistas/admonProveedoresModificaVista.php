          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php print RUTA."AdmonPlantilla/usuarios" ?>" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php print RUTA."AdmonPlantilla/productos" ?>" class="nav-link">
                      <i class="far fa-file-pdf nav-icon"></i>
                      <p>Reporte PDF</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php print RUTA."AdmonPlantilla/proveedor" ?>" class="nav-link">
                      <i class="far fa-file-pdf nav-icon"></i>
                      <p>Reporte PDF</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php print RUTA."AdmonPlantilla/marca" ?>" class="nav-link">
                      <i class="far fa-file-pdf nav-icon"></i>
                      <p>Reporte PDF</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php print RUTA."AdmonPlantilla/Caratula" ?>" class="nav-link">
                      <i class="far fa-file-pdf nav-icon"></i>
                      <p>Reporte PDF</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php print RUTA."AdmonPlantilla/color" ?>" class="nav-link">
                      <i class="far fa-file-pdf nav-icon"></i>
                      <p>Reporte PDF</p>
                    </a>
                  </li>
            ...
            <div class="card">
              ...
              <form action="<?php print RUTA; ?>admonProveedores/cambio/" method="POST">
                ...
                <div class="form-group text-left">
                    ...
                    <input type="text" name="nombre_proveedor" class="form-control form-control-border border-width-2"
                  ...
                  <div class="form-group text-left">
                    ...
                    <input type="email" name="correo" class="form-control form-control-border border-width-2" 
                  ...
                  <div class="form-group text-left">
                    ...
                    <input type="text" name="telefono_proveedor" class="form-control form-control-border border-width-2"
