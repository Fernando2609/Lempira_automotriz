...
<head>
  ...
  <title>Gráfica Ventas por Modelo</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php print RUTA; ?>carrito/graficamodelo" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<!--               Separador de Cantidad de Vendidos-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      ?>
            <h1>Gráfica Ventas Por Modelo</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="chart">
                <canvas id="ventasxmodelo" style="min-height: 250px;height: 400px;max-height: 400px;max-width: 100%;display: block;margin-top: 5px;width: 444px;"></canvas>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
