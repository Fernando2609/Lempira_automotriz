  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Datos Del Administrador: <?php  
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Admin <?php  
              print $datos["data"]["nombre"]
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    <?php  
                        print $datos["data"]["telefono_celular"];
                    ?> 
                    </td>
                  ...
                  <tr>
                    <th>Telefono fijo</th>
                    <td><?php  
                        print $datos["data"]["telefono_fijo"];
                    ?> </td>
                    
                  <tr>
                    <th>Dirección</th>
                    <td><?php  
                        print $datos["data"]["direccion"];
                    ?> </td>
                    
                    <tr>
                    <th>No Identidad</th>
                    <td><?php  
                        print $datos["data"]["no_identidad"];
                    ?> </td>
                    
                    <tr>
                    <th>Fecha de Nacimiento</th>
                    <td><?php  
                        print $datos["data"]["fecha_nacimiento"];
                    ?> </td>
                    
                    <tr>
                    <th>Último Inicio De Sesión</th>
                    <td><?php  
                        print $datos["data"]["login_dt"];
                    ?> </td>
                    
                    <tr>
                    <th>Última Vez Modificado</th>
                    <td><?php  
                        print $datos["data"]["modificado_dt"];
                    ?> </td>
                    
                    <tr>
                    <th>Fecha de Creación</th>
                    <td><?php  
                        print $datos["data"]["creado_dt"];
                    ?> 
                    </td>
