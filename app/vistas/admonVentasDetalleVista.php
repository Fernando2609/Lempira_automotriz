      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a  href="<?php print RUTA; ?>carrito/ventas"  class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="fas fa-arrow-circle-left"></i>  Regresar       </a>
