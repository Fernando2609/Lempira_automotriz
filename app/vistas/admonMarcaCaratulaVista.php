        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item ">
                <a href="<?php print RUTA."admonMarca" ?>" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                  <p>Marca</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a href="<?php print RUTA; ?>AdmonMarca/alta" class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Marca    </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Marca" target="_blank" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Marca_e" class="btn btn-block btn-outline-success" style="width: 20%;">     <i class="far fa-file-excel"></i>   Reporte Excel
              </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php
                    for($i=0; $i<count($datos['data']); $i++){
                       ...
                       print "<td class='text-center'>".$datos["data"][$i]["ID_MARCA"]."</td>";
                        ...
                        //Botone
                        print "<td style='text-align: -webkit-center;'><a href='".RUTA."admonMarca/cambio/".$datos["data"][$i]["ID_MARCA"]."'
                        class='btn btn-block w-50 bg-gradient-success btn-flat'><i class='fas fa-edit'></i></a></td>";
                        print "<td style='text-align: -webkit-center;'><a href='".RUTA."admonMarca/baja/".$datos["data"][$i]["ID_MARCA"]."'
                        class='btn btn-block bg-gradient-danger btn-flat w-50 text-center'><i class='fa fa-trash-alt'></i></a></td>";
                        print "</tr>";
                    }
                    ?>
                  </tbody>
