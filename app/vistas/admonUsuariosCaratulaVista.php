  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tabla Usuarios Administradores</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php print RUTA.'AdmonInicio/caratula'  ?>">Inicio</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a href="<?php print RUTA; ?>admonUsuarios/alta" class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Administrador        </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/usuarios" target="_blank" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/usuarios_e" class="btn btn-block btn-outline-success" style="width: 20%;">     <i class="far fa-file-excel"></i>   Reporte Excel
              </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    for($i=0; $i<count($datos['data']); $i++){
                      ...
                      print "<td>".$datos["data"][$i]["correo"]."</td>";
