...
<head>
  ...
  <title>Vendidos Por Marca</title>
...
<!--               Separador de Cantidad de Vendidos-->
              ...
              <li class="nav-item">
                <a href="<?php print RUTA; ?>carrito/graficamarcacantidad" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      ?>
            <h1>Gráfica: Vendidos Según su Marca</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="chart">
                <canvas id="ventasxautocantidad" style="min-height: 250px;height: 400px;max-height: 400px;max-width: 100%;display: block;margin-top: 5px;width: 444px;"></canvas>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
