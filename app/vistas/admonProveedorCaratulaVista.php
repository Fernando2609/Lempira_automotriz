        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item  ">
                <a href="<?php print RUTA."admonProveedores" ?>" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                  <p>Proveedores</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a href="<?php print RUTA; ?>AdmonProveedores/alta" class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Proveedor    </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Proveedor" target="_blank" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Proveedor_e" class="btn btn-block btn-outline-success" style="width: 20%;">     <i class="far fa-file-excel"></i>   Reporte Excel
              </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    for($i=0; $i<count($datos['data']); $i++){
                      ...
                      print "<td >".$datos["data"][$i]["nombre_proveedor"]."</td>";
                      print "<td >".$datos["data"][$i]["correo"]."</td>";
                      print "<td >".$datos["data"][$i]["telefono_proveedor"]."</td>";
