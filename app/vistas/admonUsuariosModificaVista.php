              ...
              <form action="<?php print RUTA; ?>admonUsuarios/cambio/" method="POST">
               <!--  <div class="form-group text-left">
                ...
                <div class="form-group text-left pt-3">
                  ...
                  <input type="password" name="clave_actual" class="form-control form-control-border border-width-2 "
                ...
                <div class="form-group text-left">
                  ...
                  <input type="password" name="clave1" class="form-control form-control-border border-width-2"
                ...
                <div class="form-group text-left">
                  ...
                  <input type="password" name="clave2" class="form-control form-control-border border-width-2"
