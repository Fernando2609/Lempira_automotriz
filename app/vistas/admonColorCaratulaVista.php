          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item  active">
                <a href="<?php print RUTA."admonColor" ?>" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                  <p>Color</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <a href="<?php print RUTA; ?>AdmonColor/alta" class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Color    </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Color"  target="_blank" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/Colore" target="_blank" class="btn btn-block btn-outline-success" style="width: 20%;">     <i class="far fa-file-excel"></i>   Reporte Excel
              </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    for($i=0; $i<count($datos['data']); $i++){
                        ...
                        //Botones
                        print "<td style='text-align: -webkit-center;'><a href='".RUTA."admonColor/cambio/".$datos["data"][$i]["ID_COLORAUTO"]."'
                        class='btn btn-block w-50 bg-gradient-success btn-flat'><i class='fas fa-edit'></i></a></td>";
                        print "<td style='text-align: -webkit-center;'><a href='".RUTA."admonColor/baja/".$datos["data"][$i]["ID_COLORAUTO"]."'
                        class='btn btn-block w-50 bg-gradient-danger btn-flat'><i class='fa fa-trash-alt'></i></a></td>";
                        print "</tr>";
                    }
                    ?>
                  </tbody>
