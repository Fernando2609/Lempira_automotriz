        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item">
                <a href="<?php print RUTA."carrito/ventas" ?>" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                  <p>Ventas</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
             ...
             <!--  <a  href="<?php print RUTA; ?>carrito/grafica"  class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Administrador        </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/usuarios" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  print "<th>Totales</th>";
                  print "<th></th>";
                  print "<th>".number_format($cos,2)."</th>";
                  print "<th>".number_format($env,2)."</th>";
                  print "<th>".number_format($isv,2)."</th>";
                  print "<th>".number_format($tot,2)."</th>";
                  print "<th></th>";
