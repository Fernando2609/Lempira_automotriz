...
<!--               Separador de Cantidad de Vendidos-->
      ...
      ?>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Modificar Auto</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <!--- Aca empieza el cambio-->
                ...
                <!--  <label for="NUMERO_CHASIS">Numero del chasis</label> -->
                  <input type="hidden" name="NUMERO_CHASIS" class="form-control form-control-border border-width-2" required 
                ...
                <div class="form-group text-left">
                  ...
                  <input type="text" name="KILOMETRAJE" class="form-control form-control-border border-width-2" required
