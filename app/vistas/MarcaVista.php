        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown active">
                  ...
                  ></a>
                  <ul>
                    <li class="active"><a  href='<?php print RUTA.'Marca'  ?>'>Marcas</a></li>
        ...
        <div class="container">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <ol>
              ...
              <li><a href='<?php print RUTA.'Marca' ?>'>Todas las Marcas</a> </li>
            </ol>
          </div>
        </div>
      </section>
      ...
      <div class="container container2" data-aos="fade-up">
         ...
         $ren = 0;
            for ($i=0; $i < count($datos["data"]); $i++) {
              ...
              print "<div class='card2 mt-3 col-sm-3'>";
              print "<a class='carta' href='".RUTA."Marca/MarcaBuscar/";
              print $datos['data'][$i]["ID_MARCA"]."'>";
             
              
              print "<H4 name='marca'>";
              print $datos['data'][$i]["DESCRIPCION"]."</H4>";
              print "</div>";
              print "</a>";
              $ren++;
