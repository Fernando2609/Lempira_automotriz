...
<head>
  ...
  <title>Modificar contraseña Administrador</title>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="<?php print RUTA; ?>admonUsuarios/cambioClavePerfil/" method="POST">
                ...
                <div class="form-group text-left">
                  <label for="clave1">Clave acceso Nueva:</label>
                ...
                <div class="form-group text-left">
                  <label for="clave2">Verifica la clave acceso Nueva:</label>
                ...
                <div class="form-group text-left d-flex justify-content-end ">
                  <input type ="hidden" id="correo" name="correo" value = "<?php print $_SESSION["email"]["email"]?>"/>
