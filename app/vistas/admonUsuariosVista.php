      ...
      <nav class="mt-3">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php print RUTA."admonUsuarios/alta" ?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group text-left">
                  ...
                  <input type="email" name="email" class="form-control form-control-border border-width-2" required
                ...
                <div class="form-group text-left">
                  ...
                  <input type="password" name="clave1" class="form-control form-control-border border-width-2" required
                ...
                <div class="form-group text-left">
                  ...
                  <input type="password" name="clave2" class="form-control form-control-border border-width-2" required
                ...
                <div class="form-group text-right">
                  ...
                  <a href="<?php print RUTA; ?>admonUsuarios" class="btn btn-info">Atrás</a>
                </div>
              </form>
              </div>
              <!-- /.card-body -->
