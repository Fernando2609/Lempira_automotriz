  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   <ul class="navbar-nav ml-auto ">
      ...
      <li class="nav-item dropdown">
            ...
            <li><?php  
              print "<a href='".RUTA."admonUsuarios/perfil/".$_SESSION["email"]["email"]."' class='nav-link'>Mí Perfil</a>";
              
              ?></li>
            <li><?php  
              print "<a href='".RUTA."admonUsuarios/cambio2/".$_SESSION["email"]["email"]."' class='nav-link'>Editar Perfil</a>";
              
              ?></li>
              <li><a href="<?php print RUTA.'AdmonInicio/logout'  ?>" class="nav-link" style="padding-right: 0.2rem;">Cerrar Sesión</a></li>
              ...
              <form action="<?php print RUTA; ?>admonProveedores/baja/" method="POST">
                ...
                <div class="form-group text-left">
                    ...
                    <div class="form-group text-left">
                      ...
                      <input type="email" name="correo" class="form-control form-control-border border-width-2" disabled
                    ...
                    <select class="custom-select form-control-border border-width-2" name="status" id="status" disabled>
