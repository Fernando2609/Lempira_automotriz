        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item  ">
                <a href="<?php print RUTA."admonProductos" ?>" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                  <p>Autos</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tabla Autos en Existencia</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
              <div class="card-header d-flex" style="justify-content: space-evenly;">
              <a href="<?php print RUTA; ?>AdmonProductos/alta" class="btn btn-block bg-gradient-info" style="width: 25%;margin-top: .5rem;" > <i class="far fa-plus-square text-right"></i>  Registrar Auto     </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/productos" target="_blank" class="btn btn-block btn-outline-danger " style="width: 20%;">    <i class="far fa-file-pdf"></i>    Reporte PDF
              </a>
              <a href="<?php print RUTA; ?>AdmonPlantilla/productos_e" class="btn btn-block btn-outline-success" style="width: 20%;">     <i class="far fa-file-excel"></i>   Reporte Excel
              </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                   for($i=0; $i<count($datos['data']); $i++){
                    ...
                    $num=$i+1;
                    print "<td >".$num."</td>";
                    print "<td>".$datos["data"][$i]["MARCA"]."</td>";
                    print "<td>".$datos["data"][$i]["MODELO"]."</td>";
                    ...
                    print "<td>"."L.".number_format($datos["data"][$i]["PRECIO"])."</td>";
                    print "<td>".$datos["data"][$i]["COLOR"]."</td>";
                    if ($datos["data"][$i]["status"]==1) {
                      print "<td activo'>".'Activo'."</td>";
                    }elseif ($datos["data"][$i]["status"]==2) {
                      print "<td inactivo'>".'Inactivo'."</td>";
                    }
                    ...
                    class='btn btn-block bg-gradient-success btn-flat'><i class='fas fa-edit'></i></a></td>";
                    print "<td><a href='".RUTA."admonProductos/baja/".$datos["data"][$i]["ID_AUTO"]."'
                    class='btn btn-block bg-gradient-danger btn-flat'>  <i class='fa fa-trash-alt'></i></a></td>";
                    print "</tr>";
                    }
                    ?>
                  </tbody>
